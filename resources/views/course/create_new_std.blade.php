<div class="modal fade" id="CreateModalNewStd">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::hidden('Addref', null, [
                                                        'id' => 'Addref',
                                                        'class' => 'form-control',
                                                        'readonly' => true,
                                                    ]) !!}
                                                    {!! Form::hidden('courses_pending_id', null, [
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <strong><i class="fa-solid fa-user-tie"></i> Father
                                                        Name:</strong>
                                                    {!! Form::text('getfName', null, ['id' => 'getfName', 'placeholder' => 'Father Name', 'class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <strong><i class="fas fa-at"></i> Email:</strong>
                                                    {!! Form::email('getfEmail', null, [
                                                        'id' => 'getfEmail',
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <strong><i class="fa-solid fa-user-tie"></i> Mother
                                                        Name:</strong>
                                                    {!! Form::text('getmName', null, ['id' => 'getmName', 'placeholder' => 'Mother Name', 'class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <strong><i class="fas fa-at"></i> Email:</strong>
                                                    {!! Form::email('getmEmail', null, [
                                                        'id' => 'getmEmail',
