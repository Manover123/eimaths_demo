...
@section('mainContent')
                ...
                <div class="col-xl-3">
                    <div class="white-box mb_30  student-details header-menu">
                        ...
                        @if (isset($edit))
                            ...
                            @else
                                @if (permissionCheck('course.category.store'))
                                    <form action="{{ route('course.category.store') }}" method="POST" id="category-form"
                                        name="category-form" enctype="multipart/form-data">
                                @endif
                        @endif
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="nameInput">{{ __('common.Name') }}
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input name="description[{{ $language->code }}]" id="descriptionInput"
                                                    class="primary_input_field description {{ @$errors->has('description') ? ' is-invalid' : '' }}"
                                                    placeholder="{{ __('common.Description') }}" type="text"
                                                    value="{{ isset($edit) ? $edit->getTranslation('description', $language->code) : old('description' . $language->code) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="parent">{{ __('common.Parent') }}</label>
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="status">{{ __('courses.Status') }}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="nowrap">
                                                        ...
                                                        <x-backend.status :org="$org_id" :id="$category->id"
                                                            :status="$category->status" :route="'course.category.status_update'"></x-backend.status>
    ...
    <input type="hidden" name="status_route" class="status_route"
        value="{{ route('course.category.status_update') }}">
