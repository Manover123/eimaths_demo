                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"> {{__('payment.Deposit history')}}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                            ...
                            <div class="">
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{__('payment.Amount')}} ({{auth()->user()->currency->symbol}}
                                            )
                                        </th>
...
@push('scripts')
    ...
    <script src="{{ asset('modules/my_panel/deposit_history.js')}}{{assetVersion()}}"></script>
    <script src="{{ asset('frontend/infixlmstheme/js/deposit.js')}}{{assetVersion()}}"></script>
@endpush
