    ...
    <div class="modal-dialog modal-xs" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title" id="exampleModalLongTitle"> <i class="fas fa-cubes"></i> Acceseries QRcode
                </h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="printqBarcodeButton"><i class="fas fa-print"></i>
                    Print</button>
