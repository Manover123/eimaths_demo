...
@section('content')
                    ...
                    <ol class="breadcrumb float-sm-right">
                        @can('student-create')
                            <button type="button" class="btn btn-success" id="CreateButton">
                                <i class="fas fa-graduation-cap"></i>Create History</button>
                        @else
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-graduation-cap"></i> History List</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                <div class="col-xs-12 col-sm-12 col-md-12" id="Listviewd">
                                    <form method="post" action="{{ route('histories.destroy_all') }}" name="delete_all"
                                        id="delete_all">
                                        @csrf
                                        @method('POST')
                                        <table id="Listview"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="1%" class="text-center">Centre</th>
    ...
    @include('histories.create')

    @include('histories.view')
    @include('histories.edit')
    @include('histories.log')
