                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mt-4">
                            ...
                            @foreach ($options as $index => $option)
                                <div class="flex mt-2">
                                    <x-text-input type="text" wire:model.defer="options.{{ $index }}.text" class="w-full" name="options_{{ $index }}"
                                        id="options_{{ $index }}" autocomplete="off" />

                                    <div class="flex items-center">
                                        <input type="checkbox" class="mr-1 ml-4" wire:model.defer="options.{{ $index }}.correct"> Correct
