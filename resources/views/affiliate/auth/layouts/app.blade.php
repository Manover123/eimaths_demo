...
<head>
    ...
    @if (isRtl())
        <link rel="stylesheet"
            href="{{ asset('frontend/infixlmstheme') }}/css/bootstrap.rtl.min.css{{ assetVersion() }} ">
    @else
        <link rel="stylesheet" href="{{ asset('frontend/infixlmstheme') }}/css/bootstrap.min.css{{ assetVersion() }} ">
    @endif

    <link rel="stylesheet" href="{{ asset('frontend/infixlmstheme') }}/css/app.css{{ assetVersion() }}">
    @if (isRtl())
        <link rel="stylesheet"
            href="{{ asset('frontend/infixlmstheme') }}/css/frontend_style_rtl.css{{ assetVersion() }}">
    @else
        <link rel="stylesheet"
    ...
    <script>
        window._locale = '{{ app()->getLocale() }}';
        window._translations = @json($jsonLang ?? []);
    </script>
    {{-- <x-analytics-tool /> --}}
