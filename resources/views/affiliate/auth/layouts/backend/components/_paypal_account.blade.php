                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            <div class="add-visitor">
                                {{-- {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'affiliate.add_or_update_paypal_account','method' => 'POST']) }} --}}
                                ...
                                <div class="account_profile_form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label class="primary_label2" for="paypal_account">
                                                {{ __('affiliate.Paypal Account') }}</label>
