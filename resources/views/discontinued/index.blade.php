...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @can('student-edit')
                            <button type="button" class="btn btn-danger delete_all_button"><i class="fa-solid fa-retweet"></i> Restart
                                All</button>
                        @else
                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" data-placement="bottom"
                                title="You Not Have Permission">
                                <button type="button" class="btn btn-danger disabled"><i class="fa-solid fa-retweet"></i>
                                    Restart All</button>
                            </span>
                        @endcan
                    </ol>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-handshake-slash"></i> Discontinued Student</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row ">
                                <div class="col-xs-12 col-sm-12 col-md-12" id="Listviewd">
                                    <form method="post" action="{{ route('discontinued.restart_all') }}" name="delete_all"
                                        id="delete_all">
                                        @csrf
                                        @method('POST')
                                        <table id="Listview"
    ...
    {{--  {!! $data->render() !!} --}}
    @include('discontinued.course')
@endsection

@section('script')
    @include('discontinued.script')
@endsection
