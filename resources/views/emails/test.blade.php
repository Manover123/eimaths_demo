                                        ...
                                        <tr>
                                            <td class="wrapper">
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td>
                                                            <a href="/"><img src="/assets/img/logo/logo-admin.png"
                                                                    height="20px" /></a>
                                                        </td>
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td class="last">
                                                        ...
                                                        <p class="m-b-5">Please click the following URL to activate
                                                            your account:</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="panel">
                                                        <a
                                                            href="javascript:;">https://www.wrapbootstrap.com/registration/activate/?code=28a782891</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p class="m-t-15 last">If clicking the URL above does not work,
                                                            copy and paste the URL into a browser window.</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        <h4>Discount 80%!</h4>
                                                        <p>
                                                            Quisque eget pulvinar nisi, et mattis leo. Aenean nec ligula
                                                            aliquet, tincidunt massa ac, eleifend velit. Ut ac enim a
                                                            enim tempor volutpat. Mauris quis sagittis nunc, et
                                                            convallis nulla. Fusce gravida lacus sed vulputate
                                                            scelerisque.
                                                        </p>
                                                        <p>

                                                            <img src="/assets/img/product/product-preview.jpg" />
                                                            <img src="{{ asset('assets/img/product/product-preview.jpg') }}"
                                                                height="20px" />
                                                            <img src="../assets/img/product/product-preview.jpg"
                                                                height="20px" />
