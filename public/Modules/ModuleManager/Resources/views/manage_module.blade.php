...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            <div class="white-box">
                <div class="row">
                    <div class="col-lg-12 pb-20 main-title">
                        <h3 class="mb-0 d-flex justify-content-between align-items-center flex-wrap row-gap-3 mb-3">
                            <span>{{__('setting.Module')}} {{__('setting.Manage')}}</span>
                            @if(!config('app.demo_mode'))
                                <a data-bs-toggle="modal"
                                   data-bs-target="#add_module" href="#"
                                   class="primary-btn fix-gr-bg small pull-right float-end">  {{__('common.Add')}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(!empty($module->verify->purchase_code)) <p
                                                            ...
                                                            @else
                                                                {{translatedNumber(\Illuminate\Support\Carbon::now()->translatedFormat('F jS, Y'))}}
                                                            @endif
                                                        </p>
                                                        @if(!config('app.demo_mode'))
