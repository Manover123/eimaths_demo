                        ...
                        <form method="POST" action="{{ route('paymentmethodsetting.changePaymentGatewayStatus') }}"
                            ...
                            <div class="row">
                                ...
                                @foreach ($payment_methods as $Key => $payment_method)
                                    ...
                                    {{-- @if ($payment_method->method === 'Bank Payment' || $payment_method->method === 'Offline Payment') --}}
                                            ...
                                            <div class="primary_input ">
                                                <div class="input-effect">
                                                    ...
                                                    <label class="primary_checkbox d-flex mr-12 text-nowrap"
                                                        ...
                                                        <span class="checkmark me-2"></span>{{ $payment_method->method }}
                                                    </label>
                                                </div>
                ...
                <div class="col-lg-9 ">
                    <div class="white-box">
                        <div class="payment_getway_tab ">
                            <div class="main-title pt-0 ">
                                <h3 class="mb-25 d-flex justify-content-between flex-wrap row-gap-3">
                                    ...
                                    <a href="{{ route('paymentmethodsetting.test') }}" class="primary-btn small fix-gr-bg"
                                        style="">
                            ...
                            <ul class="nav nav-tabs scrollable no-bottom-border  mt-sm-md-20 mb-10" style="margin-left:0"
                                role="tablist">
                                {{-- @foreach ($payment_methods->where('method', '!=', 'Offline Payment')->where('method', '!=', 'Wallet') as $Key => $payment_method) --}}

                                @foreach ($payment_methods->where('method', '=', 'Bank Payment') as $key => $payment_method)
                                    @php
                                        // dd($payment_method->method);
                                        // if ($payment_method->method != 'Bank Payment') {
                                        //     # code...
                                        //     //exit loop
                                        //     break;
                                        // }
                                    ...
                                    @if ($payment_method->method === 'Bank Payment')
                                        <li class="nav-item m-1">
                                            <a class="nav-link  {{ $Key == 0 ? 'active' : '' }} "
                                                href="#method{{ $payment_method->id }}" role="tab"
                                                data-bs-toggle="tab">{{ @$payment_method->method }}</a>
                                        </li>
                                    @endif
                        ...
                        <div class="tab-content">
                            ...
                            {{-- @foreach ($payment_methods->where('method', '!=', 'Offline Payment')->where('method', '!=', 'Wallet') as $key => $payment_method) --}}
                            @foreach ($payment_methods->where('method', '=', 'Bank Payment') as $key => $payment_method)
                                <div role="tabpanel" class="tab-pane fade  {{ $key == 5 ? 'active' : '' }}  show "
                                    id="method{{ $payment_method->id }}">

                                    <form class="form-horizontal"
                                        @if (permissionCheck('paymentmethodsetting.payment_method_setting_update')) action="{{ route('paymentmethodsetting.update_payment_gateway') }}" @endif
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="white-box">
                                            @php
                                                // dd($payment_method->method);
                                                // dd($payment_method->method, $key);
                                            ...
                                            <div class="col-md-12 ">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <label class="mb-2">{{ __('setting.Bank Name') }}
                                                                        </label>
                                                                        <input required
                                                                ...
                                                                <div class="col-lg-4 mb-25" style="margin-top: -10px;">
                                                                    <div class="input-effect">
                                                                        <label class="mb-2">{{ __('setting.Type') }}
                                                                        </label>
                                                                        <select class="primary_select" name="type"
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                {{ __('setting.Account Type') }}</option>
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <label class="mb-2">{{ __('setting.Account PromptPay Number') ?? 'Account PromptPay Number'}}
                                                                        </label>
                                                                        <input required
                                                                            class="primary-input-field form-control "
                                                                            type="text" name="account_promptpay_number"
                                                                            id="account_promptpay_number" autocomplete="off"
                                                                            value="{{ getPaymentEnv('ACCOUNT_PROMPTPAY_NUMBER') ? getPaymentEnv('ACCOUNT_PROMPTPAY_NUMBER') : '' }}">
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            id="instamojo_api_auth" required
                                                                            autocomplete="off"
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="instamojo_auth_token" autocomplete="off"
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="instamojo_url" autocomplete="off"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3 mb-25">
                                                                    <label class="mb-2">{{ __('setting.Environment') }}
                                                                    </label>
                                                                    <div
                                                                            ...
                                                                            <div class="">
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="midtrans_env"
                                                                                            @if (getPaymentEnv('MIDTRANS_ENV') == '0') checked @endif
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        @if (getPaymentEnv('MIDTRANS_SANITIZE') != '1') checked @endif
                                                                                        id="midtrans_sanitize_no{{ $payment_method->id }}"
                                                                                        value="false"
                                                                                        class="common-radio relationButton read-only-input">
                                                                                    <span class="checkmark me-2"></span>
                                                                                    {{ __('common.Sanitize No') }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="input-effect">
                                                                        ...
                                                                        <div class="input-effect">
                                                                            <div class="text-start float-start">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        name="midtrans_3ds"
                                                                                        @if (getPaymentEnv('MIDTRANS_3DS') == '0') checked @endif
                                                                ...
                                                                <div class="col-lg-6 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input class="primary-input-field form-control"
                                                                            ...
                                                                            id="payeer_key" required autocomplete="off"
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="ssl_store_password" autocomplete="off"
                                                                            ...
                                                                            <div class="text-start float-start">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio" name="ssl_mode"
                                                                                        @if (getPaymentEnv('IS_LOCALHOST') == 'true') checked @endif
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="pesapal_client_secret" autocomplete="off"
                                                                            ...
                                                                            <div class="">
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="pesapal_mode"
                                                                                            @if (getPaymentEnv('PESAPAL_IS_LIVE') == 'false') checked @endif
                                                                                            id="mode_check_{{ $payment_method->id }}"
                                                                                            value="1"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="pesapal_mode"
                                                                                            id="live_mode_check_{{ $payment_method->id }}"
                                                                                            @if (getPaymentEnv('PESAPAL_IS_LIVE') == 'true') checked @endif
                                                                                            value="2"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                            class="checkmark me-2"></span>
                                                                ...
                                                                <div class="col-lg-6 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input class="primary-input-field form-control"
                                                                            ...
                                                                            id="mobilpay_merchant_id" required
                                                                            autocomplete="off"
                                                                            ...
                                                                            <div class="">
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="mobilpay_mode"
                                                                                            @if (getPaymentEnv('MOBILPAY_TEST_MODE') == 'true') checked @endif
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="paypal_client_secret" autocomplete="off"
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="paypal_mode"
                                                                                            @if (getPaymentEnv('IS_PAYPAL_LOCALHOST') == 'true') checked @endif
                                                                                            id="mode_check_{{ $payment_method->id }}"
                                                                                            value="1"
                                                                                            class="common-radio relationButton read-only-input">
                                                            ...
                                                            <div class="row">
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="paytm_mode"
                                                                                            @if (getPaymentEnv('PAYTM_ENVIRONMENT') == 'local') checked @endif
                                                                                            id="mode_check_{{ $payment_method->id }}"
                                                                                            value="local"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="paytm_mode"
                                                                                            id="live_mode_check_{{ $payment_method->id }}"
                                                                                            @if (getPaymentEnv('PAYTM_ENVIRONMENT') == 'production') checked @endif
                                                                                            value="production"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                            class="checkmark me-2"></span>
                                                                ...
                                                                <div class="col-lg-6 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            class="primary-input-field form-control"
                                                                            type="text" name="paytm_merchant_website"
                                                                            id="razor_secret" autocomplete="off"
                                                    ...
                                                    <div class="row mb-25">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        <label class="mb-2">{{ __('setting.App Key') }}

                                                                        </label>
                                                                        <input class="primary-input-field form-control"
                                                                            type="text" name="bkash_app_key"
                                                                            id="bkash_app_key" required autocomplete="off"
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="bkash_app_secret" autocomplete="off"
                                                                ...
                                                                <div class="col-lg-4 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            ...
                                                                            id="bkash_password" autocomplete="off"
                                                                            ...
                                                                            <div class="">
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="bkash_mode"
                                                                                            @if (getPaymentEnv('IS_BKASH_LOCALHOST') == 'true') checked @endif
                                                                                            id="mode_check_{{ $payment_method->id }}"
                                                                                            value="1"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                            ...
                                                            <div class="row">
                                                                            ...
                                                                            <div class="">
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="razerms_mode"
                                                                                            @if (getPaymentEnv('RAZERMS_ENVIRONMENT') == 'local' || !getPaymentEnv('RAZERMS_ENVIRONMENT')) checked @endif
                                                                                            id="mode_check_{{ $payment_method->id }}"
                                                                                            value="local"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            name="razerms_mode"
                                                                                            id="live_mode_check_{{ $payment_method->id }}"
                                                                                            @if (getPaymentEnv('RAZERMS_ENVIRONMENT') == 'production') checked @endif
                                                                                            value="production"
                                                                                            class="common-radio relationButton read-only-input">
                                                                                        <span
                                                                                            class="checkmark me-2"></span>
                                                                ...
                                                                <div class="col-lg-6 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input required
                                                                            class="primary-input-field form-control"
                                                                            type="text" name="razerms_private_key"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row mt-2 mb-2">
                                                                <div class="col-lg-6 mb-25">
                                                                    <div class='input-effect'>
                                                                        <label for="">
                                                                            {{ __('setting.Auto Redirect') }}
                                                                            {{ getPaymentEnv('EASY_PAISA_AUTO_REDIRECT') }}</label>
                                                                        <select class="form-control"
                                                                            name="EASY_PAISA_AUTO_REDIRECT">
                                                                            <option
                                                                                {{ !empty(getPaymentEnv('EASY_PAISA_AUTO_REDIRECT')) && getPaymentEnv('EASY_PAISA_AUTO_REDIRECT') == 0 ? 'selected' : '' }}
                                                                                value="0">{{ trans('common.No') }}
                                                                            </option>
                                                                            <option
                                                                                {{ !empty(getPaymentEnv('EASY_PAISA_AUTO_REDIRECT')) && getPaymentEnv('EASY_PAISA_AUTO_REDIRECT') == 1 ? 'selected' : '' }}
                                                                                value="1">{{ trans('common.Yes') }}
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <div class="text-start float-start">
                                                                                    <label
                                                                                        ...
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            @if (getPaymentEnv('AUTHORIZE_NET_ENVIRONMENT') == '0') checked @endif
                                                ...
                                                @elseif($payment_method->method == 'Braintree')
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                            <div class='input-effect mb-25'>
                                                                <label class="mb-2" for="{{ $payment_method->id }}">
                                                                        ...
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    ...
                                                                                    @if (getPaymentEnv('BRAINTREE_ENVIRONMENT') == 'sandbox') checked @endif
                                                                        ...
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    ...
                                                                                    @if (getPaymentEnv('FLW_ENVIRONMENT') == 'sandbox') checked @endif
                                                                        ...
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    ...
                                                                                    @if (getPaymentEnv('JAZZ_CASH_ENVIROMENT') == 'LIVE') checked @endif
                                                                                    id="mode_check_{{ $payment_method->id }}"
                                                                                    value="LIVE"
                                                                                    class="common-radio relationButton read-only-input">
                                                                    ...
                                                                    <div class="">
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    name="JAZZ_CASH_ENVIROMENT"
                                                                                    @if (getPaymentEnv('JAZZ_CASH_ENVIROMENT') == 'SANDBOX') checked @endif
                                                                        ...
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    ...
                                                                                    @if (getPaymentEnv('Tranzak_ENVIRONMENT') == 'sandbox') checked @endif
                                                                    ...
                                                                    <div class="">
                                                                        <div class="text-start float-start">
                                                                            <label class="primary_checkbox d-flex mr-12"
                                                                                ...
                                                                                <input type="radio"
                                                                                    name="Tranzak_ENVIRONMENT"
                                                                                    @if (getPaymentEnv('Tranzak_ENVIRONMENT') == 'live') checked @endif
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3">
                                                            <div class='input-effect mb-25'>
                                                                ...
                                                                <input type="hidden" name="payment_method_id"
                                                                    value="{{ $payment_method->id }}">
                                                                <input type="text" id='mi{{ $payment_method->id }}'
                                                        ...
                                                        <div class="col-lg-3 col-md-3">
                                                            <div class='input-effect mb-25'>
                                                                ...
                                                                <input type="text" id='ac{{ $payment_method->id }}'
                                                        ...
                                                        <div class="col-lg-3 col-md-3">
                                                            <div class='input-effect mb-25'>
                                                                ...
                                                                <input type="text" id='sr{{ $payment_method->id }}'
                                                            ...
                                                            <div class='input-effect mb-25'>
                                                                ...
                                                                <select class="primary_select"
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        {{ __('setting.Account Type') }}</option>
                                                                    <option value="sha256"
                                                                        {{ (getPaymentEnv('AmazonPayment_SHAType') ? getPaymentEnv('AmazonPayment_SHAType') : '') == 'sha256' ? 'selected' : '' }}>
                                                                        SHA-256
                                                                    </option>
                                                                    <option value="sha512"
                                                                        {{ (getPaymentEnv('AmazonPayment_SHAType') ? getPaymentEnv('AmazonPayment_SHAType') : '') == 'sha512' ? 'selected' : '' }}>
                                                                        SHA-512
                                                                    </option>
                                                                            ...
                                                                            <div class="text-start float-start">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        @if (getPaymentEnv('AmazonPayment_ENVIRONMENT') == 'sandbox') checked @endif
                                                                        ...
                                                                        <div class="">
                                                                            <div class="text-start float-start">
                                                                                <label
                                                                                    ...
                                                                                    <input type="radio"
                                                                                        name="AmazonPayment_ENVIRONMENT"
                                                                                        @if (getPaymentEnv('AmazonPayment_ENVIRONMENT') == 'live') checked @endif
                                                                ...
                                                                <div class="col-lg-12 mb-25">
                                                                    <div class="input-effect">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            type="text" name="TAP_PAYMENT_API_KEY"
                                                                            id="TAP_PAYMENT_API_KEY" required
                                                                            autocomplete="off"
                                                                                    ...
                                                                                    <div class="text-start float-start">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                ...
                                                                                                @if (getPaymentEnv('AstraPay_ENVIRONMENT') != 'live') checked @endif
                                                ...
                                                @endif --}}
                                                @if (
                                                    // $payment_method->method != 'Bank Payment' &&
                                                    $payment_method->method != 'Offline Payment' && $payment_method->method != 'Wallet')
                                                    <div class="row imageBox mt-4">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="payment_gateway_preview_image_contaienr">
                                                                <div class="img">
