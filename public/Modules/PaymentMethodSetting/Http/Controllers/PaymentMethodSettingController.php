        ...
        try {
            ...
            if ($method->method == 'Sslcommerz') {
                ...
                try {
                    ...
                    $method_setup->ACCOUNT_PROMPTPAY_NUMBER = trim($request->account_promptpay_number);
                    ...
                    if ($gateway->type != "System") {
                        ...
                        if (!empty($valid)) {
                            ...
                            if (!empty($active) && $active->status == 1) {
                                ...
                                Toastr::error(
                                    $gateway->method . ' ' . trans('frontend.Not Active'),
                                    trans('common.Error')
                                );
                                return redirect()->back();
                            }
                            ...
                            Toastr::error(
                                $gateway->method . ' ' . trans('frontend.Not Verified yet'),
                                trans('common.Error')
                            );
                            return redirect()->back();
                        }
