...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        <input type="hidden" value="{{route('affiliate.pending_withdraw.datatable')}}" id="datatable_url">
        <input type="hidden" value="{{route('affiliate.confirm_withdraw',':id')}}" id="confirm_withdraw_url">
    </section>
@endsection
@push('scripts')
    <script src="{{asset('Modules/Affiliate/Resources/assets/js')}}/pending_withdraw_index.js"></script>
    <script src="{{asset('Modules/Affiliate/Resources/assets/js')}}/withdraw.js"></script>
