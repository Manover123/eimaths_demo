                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input mb-25">
                                ...
                                <input step="0.01" autocomplete="off" name="withdraw_amount" id="withdraw_amount"
                                       value="{{old('withdraw_amount')}}" class="primary_input_field"
                                       placeholder="{{__('affiliate.Withdraw Amount') }}" type="number">
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input mb-15">
                                <label class="primary_input_label" for="payment_type">{{__('affiliate.Payment Type')}}
