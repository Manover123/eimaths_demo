<div class="modal fade admin-query" id="edit_withdraw_request_modal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="d-flex justify-content-center">
                                    <button id="transfer_submit_btn" class="primary-btn semi_large2  fix-gr-bg  "
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label"
                                           for="payment_type">{{__('affiliate.Payment Type')}} <span
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="d-flex justify-content-center">
                                    <button id="withdraw_submit_btn" class="primary-btn semi_large2  fix-gr-bg  "
                                            type="submit"><i class="ti-check"></i>{{__('common.Submit') }}</button>
                                    <button class="primary-btn semi_large2  fix-gr-bg" id="save_button_parent"
                                            data-bs-dismiss="modal" type="button"><i
                                            class="ti-check"></i>{{__('common.Cancel') }}</button>
