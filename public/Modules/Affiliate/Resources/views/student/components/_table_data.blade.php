<div class="row student-details student-details_tab affiliate_tabs_container mt_0_sm m-0 white_box">
    <div class="col-lg-12 p-0">
        ...
        <div class="tab-content mt-15">
            @include('affiliate::student.components.tableDataComponents._affiliate_link')
            @include('affiliate::student.components.tableDataComponents._commissions')
            @include('affiliate::student.components.tableDataComponents._transaction')
        </div>
    </div>
</div>
